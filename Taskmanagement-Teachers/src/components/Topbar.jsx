          ...
          >
            ...
            >
              <div className="h-full w-full rounded-[14px] bg-white border-2 border-white overflow-hidden">
                <img 
                  src={user?.profileImage ? `${getApiBaseUrl()}/${user.profileImage}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'Teacher')}&background=6366f1&color=fff&rounded=true&bold=true`} 
                  alt="User" 
