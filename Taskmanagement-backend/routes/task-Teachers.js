...
const { submitTask, getMySubmission, gradeSubmission } = require("../controllers/submissionController");
...
routes.put("/submissions/:id/grade", authMiddleware, gradeSubmission);
